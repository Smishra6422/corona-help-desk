          ...
          >
            <MDBRow>
              <MDBCol md="12" className="mb-4 white-text text-center">
                ...
                >
                  Shubham{" "}
                  <span className="indigo-text font-weight-bold">Kumar</span>
                </h1>
            ...
            <div style={{ background: "#fff" }} className=" description">
              <MDBCol md="12" className="text-center">
                ...
                <div className="projects">
                  ...
                  <a href="http://corona-help-desk.herokuapp.com/">
                    Corona Help Desk
                  </a>{" "}
                  <a href="https://phonebook-list.herokuapp.com/">
                    Phone-Book App
                  </a>{" "}
                </div>
                .
                <h5>
                  I would like to thank my friend E.Ajay Bharath to guide me in
